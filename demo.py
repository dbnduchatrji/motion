...
def main():
    ...
    # these points can be an ouput from the path planning algorithm, the path is jaggered
    # and the path needs to follow the 
    pts = [(-10,-7), (-6,0), (-4, 6), (0, 5), (0,-2), (-2, -6), (3, -5), (3, 6), (6, 4)]
